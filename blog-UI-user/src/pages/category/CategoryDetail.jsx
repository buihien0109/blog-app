...
import { useGetBlogsOfCategoryQuery, useGetCategoryBySlugQuery } from '../../app/services/category.api';
...
function CategoryDetail() {
    ...
    const {
        data: pageData,
        isLoading: isLoadingBlogsOfCategory,
        isError: isErrorBlogsOfCategory,
        isFetching: isFetchingBlogsOfCategory
    ...
    if (isLoadingCategory || isLoadingBlogsOfCategory || isLoadingMostViewBlog || isFetchingCategory || isFetchingBlogsOfCategory || isFetchingMostViewBlog) {
        return <Loading />;
    }

    if (isErrorCategory || isErrorBlogsOfCategory || isErrorMostViewBlog) {
        return <Error />;
    }
    ...
    const onPageChange = (page) => {
        ...
        if (page === 1) {
            ...
            navigate(`/danh-muc/${categorySlug}?page=${page}`);
        }
    };
            ...
            <div className="max-w-6xl mx-auto py-7">
                <div className="grid grid-cols-3 gap-6">
                    <div className="col-span-2 pr-4">
                        <h2 className="mb-0 text-lg font-semibold">Danh mục: {category.name}</h2>
                        <div className="mt-6 grid grid-cols-1 gap-6 md:mt-6 md:grid-cols-2 md:gap-6">
